...
function VentasImportarParis() {
  ...
  const handleImportar = async () => {
    ...
    try {
      const res = await fetch('${import.meta.env.VITE_API_URL}/api/ventas/importar-paris', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">🛍️ Importar Ventas - Paris</h1>
...
export default VentasImportarParis;
